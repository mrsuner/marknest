...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-base-100 via-base-200 to-base-100 flex items-center justify-center p-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl lg:text-4xl font-light text-base-content mb-2 tracking-tight">Join MarkNest</h1>
          <p className="text-base-content/60 text-lg font-light">Begin your journey of mindful writing</p>
        </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-4 bg-base-100 border rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 text-base placeholder:text-base-content/40 ${
                      errors.name ? 'border-error focus:ring-error/20 focus:border-error' : 'border-base-300'
                    }`}
                    required
                  />
                  {errors.name && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-4 bg-base-100 border rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 text-base placeholder:text-base-content/40 ${
                      errors.email ? 'border-error focus:ring-error/20 focus:border-error' : 'border-base-300'
                    }`}
                    required
                  />
                  {errors.email && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-4 bg-base-100 border rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 text-base placeholder:text-base-content/40 ${
                      errors.password ? 'border-error focus:ring-error/20 focus:border-error' : 'border-base-300'
                    }`}
                    required
                  />
                  {errors.password && (
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-4 bg-base-100 border rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 text-base placeholder:text-base-content/40 ${
                      errors.confirmPassword ? 'border-error focus:ring-error/20 focus:border-error' : 'border-base-300'
                    }`}
                    required
                  />
              ...
              <div>
                <label className="flex items-start gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-5 h-5 text-primary bg-base-100 border rounded focus:ring-primary/20 focus:ring-2 mt-1 ${
                ...
                {errors.terms && (
                  <p className="mt-2 text-sm text-error font-medium">{errors.terms}</p>
                )}
              </div>
